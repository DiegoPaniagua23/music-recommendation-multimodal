...
El código fuente completo, los scripts de procesamiento, los notebooks de experimentación y la documentación detallada para reproducir los experimentos se encuentran disponibles públicamente en el siguiente repositorio de GitHub:

\url{https://github.com/DiegoPaniagua23/music-recommendation-multimodal}
